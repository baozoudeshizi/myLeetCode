...
public class QueueDogCat {
    ...
    public static class PetEnterQueue{
        private Pet pet;
        private long count;//一个整体的count，当dog，cat进来，都会讲count拷贝给dog，cat各自的count
    ...
    public static class DogCatQueue{
        ...
        //这里需要弹出最早进队列的猫或者狗，但猫狗在不同的队列，我们如何判断谁先进的呢？
        //我们在DogCatQueue的时候设计了一个count，就是类似于进队列的顺序时间戳，比较猫队首和狗队首的时间戳即可
        public Pet pollAll(){
            if(!this.dogQ.isEmpty() && !this.catQ.isEmpty()){
                if(this.dogQ.peek().count<this.catQ.peek().count){ //比较谁先进的
